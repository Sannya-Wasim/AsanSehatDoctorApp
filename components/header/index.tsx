...
export function MainScreenHeader({ toggleDrawer,walletNav }: PropsMainScreen) {
  return (
    <View style={{ backgroundColor: WHITE, width: Dimensions.get('screen').width, position: "absolute", top: 0, paddingVertical: 10, paddingHorizontal: 30, flexDirection: "row", alignItems: "center" }}>
      <Icon name='menu' size={30} color={BLACK} style={{ flexBasis: "25%" }} onPress={() => toggleDrawer()} />
      <Image source={require('../../assets/png/DrawerLogo.png')} style={{ height: scale(40), flexBasis: "50%", alignSelf: "center" }} resizeMode='contain' />
