    ...
    return (
        <SafeAreaView style={styles.mainContainer}>
            ...
            <View style={styles.container}>
                ...
                <PasswordInput inputState={confirmPassword} label={"Confirm Password"} placeholder='Enter Password Here' />

                <Pressable style={[GlobalStyle.filedButton,{marginTop:scale(40)}]} onPress={()=>dispatch(setAuthSkiped(true))}>
