...
import { View, Text, Image, Dimensions, Pressable, ScrollView, SafeAreaView } from 'react-native';
...
const HomeScreen = ({ navigation }: Props) => {
    ...
    return (
        <SafeAreaView style={styles.mainContainer}>
            <MainScreenHeader toggleDrawer={toggleDrawer} walletNav={() => navigation.navigate("Wallet")} />
            <View style={styles.container}>
                <View style={{ backgroundColor: RED_COLOR, flexDirection: "row", height: scale(130), padding: scale(5), marginTop: scale(50), borderRadius: scale(5), }}>
                    <View style={{ flexBasis: '60%', padding: scale(10) }}>
                        <Text style={{ color: WHITE, fontSize: scale(16), fontWeight: 'bold' }}>Dr. Nadeem Ahmed</Text>
                        <Text style={{ color: WHITE, fontSize: scale(14) }}>General Physician</Text>
                        <Text style={{ color: WHITE, fontSize: scale(10), marginVertical: scale(20) }}>MBBS, Ph.D.</Text>
                    </View>
                    <Image source={require('../../assets/png/doctorImage.png')} style={{ width: scale(135), height: scale(153), borderRadius: scale(5), position: 'absolute', bottom: scale(10), right: scale(10) }} />
                </View>
